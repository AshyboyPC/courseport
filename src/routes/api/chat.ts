...
const SYSTEM_PROMPT = `You are Scholaport — an empathetic, knowledgeable academic advisor helping international high-school students survive and thrive after transferring to a new country.
      ...
      POST: async ({ request }) => {
        ...
        return result.toUIMessageStreamResponse({
          onError: (error) => {
            ...
            if (err?.statusCode === 402) return "AI credits exhausted on this workspace.";
